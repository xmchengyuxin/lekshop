  ...
  children: [
    {
      ...
      name: 'adminTable',
      meta: { title: '管理员', icon: 'list', role: ['admin'] }
    },
    {
      path: 'adminType',
      component: () => import('@/views/system/adminType/index'),
      name: 'adminTypeTable',
      meta: { title: '角色管理',icon: 'list',  role: ['admin'] }
    },
    {
      path: 'params',
      component: () => import('@/views/system/params/index'),
      name: 'params',
      meta: { title: '系统参数',icon: 'list',  role: ['admin'] }
    },
    {
      path: 'modParams',
      component: () => import('@/views/system/params/modParams'),
      name: 'modParams',
      meta: { title: 'APP更新',icon: 'list',  role: ['admin'] }
    },
		 {
		  path: 'menuList',
		  component: () => import('@/views/system/menu/index'),
		  name: 'menuList',
		  meta: { title: '菜单管理',icon: 'list',  role: ['admin'] }
		},
    {
    	path: 'center',
