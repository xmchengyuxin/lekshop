...
public final class RSAUtils
{
	...
	public static final PublicKey getPublicKey(String publicKey) throws Exception {
		return getPublicKey(new BASE64Decoder().decodeBuffer(publicKey));
	}
	
	public static final PrivateKey getPrivateKey(String privateKey) throws Exception {
		return getPrivateKey(new BASE64Decoder().decodeBuffer(privateKey));
	}
}