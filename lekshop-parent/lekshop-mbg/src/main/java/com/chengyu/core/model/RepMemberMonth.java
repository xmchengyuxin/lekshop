...
public class RepMemberMonth implements Serializable {
    private Integer id;

    @ApiModelProperty(value = "统计月份")
    private String month;

    @ApiModelProperty(value = "本月总人数")
    private Integer totalNum;

    @ApiModelProperty(value = "本月活跃人数")
    private Integer activiteNum;

    @ApiModelProperty(value = "本月注册数量")
    private Integer registerNum;

    @ApiModelProperty(value = "本月下单人数")
    private Integer orderNum;

    @ApiModelProperty(value = "本月小程序注册人数")
    private Integer xcxNum;

    @ApiModelProperty(value = "本月APP注册人数")
    private Integer appNum;

    @ApiModelProperty(value = "本月H5注册人数")
    private Integer linkNum;

    @ApiModelProperty(value = "本月小程序下单人数")
    private Integer xcxOrderNum;

    @ApiModelProperty(value = "本月APP下单人数")
    private Integer appOrderNum;

    @ApiModelProperty(value = "本月H5下单人数")
