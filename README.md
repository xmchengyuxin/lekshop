...
- 多商户系统：商户入驻, 后台审批。
- 逛一逛：短视频带货。
- 多语言支持：支持多种语言(简体,英,繁体)切换，我司有另外的<a href="https://www.lekshop.cn/16552.html" target="_blank">跨境电商系统, 前往体验</a>。
- 商城装修：支持商城自定义装修.
- 在线聊天：内置在线客服聊天系统
<br>
...
<p>1. 开发电脑PC端 (在我们跨境商城项目中, 其实已经有PC端, 一直没有空整合过来)</p>
<p style="text-decoration: line-through;">2. 将SpringBoot升级到2.7 (已完成)</p>
<p>3. 商品spu功能开发</p>
<p>4. 完善分销体系, 邀请功能目前虽然存在, 但是前端页面显示不明显</p>
<p>5. 多客服系统, 目前是内置单客服系统, 后续要改成多客服系统</p>
<p style="text-decoration: line-through;">6. 微信升级到V3接口, 其他项目已升级, 目前还没时间搬迁过来 (已完成)</p>
<p>7. 本系统完全免费开源,不会有额外的收费, 也不会有隐藏的收费项目, 加我微信的不必再咨询此问题</p>
<p>8. 打个广告: 我司的跨境电商是基于此项目二次开发的, 包含买家端h5, app, 买家pc端, 总后台, 卖家pc端, 卖家h5, 
无货源跨境模式, 支持16种语言切换, 100个国家, 后台自动下单, 商品采集等完善的功能, 详情可前往查看
<a href="https://www.lekshop.cn/16552.html" target="_blank">跨境电商系统, 前往体验</a></p>
